class MeetingsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @meeting.save
        format.html { redirect_to @meeting, notice: '会议预定成功.' }
  ...
  def update
    respond_to do |format|
      if @meeting.update(meeting_params)
        format.html { redirect_to @meeting, notice: '会议更新成功.' }
  ...
  def destroy
    @meeting.destroy
    respond_to do |format|
      format.html { redirect_to meetings_url, notice: '会议已删除.' }
  ...
  private
    ...
    def must_be_admin
      unless current_user.admin?
        redirect_to meetings_path, alert: "你没有权限访问该页面"
      end
    end
end
